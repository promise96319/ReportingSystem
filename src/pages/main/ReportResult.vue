<template>
  <div class="accounting-entries">
    ...
    <div class="main">
      ...
      <div v-else class="match-tip">
        <div class="tip">
          There are still some accounts to be matched. Please complete the
          matching work at first.
        </div>
        <el-button type="primary" @click="$router.push({ name: 'Mapping' })"
    ...
    >
      <div class="filter-container">
        ...
        >
          ...
          <el-col :span="18" class="input">
            <div class="el-input el-input--mini el-input--suffix">
              ...
              >
                <span v-if="item.keywords.join(',')">{{
                  item.keywords.join(', ')
                }}</span>
                <span v-else class="placeholder">{{ item.label }}</span>
              </div>
            </div>
          </el-col>
        </el-row>
        ...
        >
          <el-col :span="6" class="label"></el-col>
          <el-col :span="18" class="input">
            <el-button class="full-width" type="primary" @click="resetFilter">
    ...
    >
      <div class="drawer-filter">
        ...
        <el-row :gutter="20" class="confirm" type="flex">
          <el-col>
            <el-button type="primary" @click="confirmFilter">OK</el-button>
          </el-col>
          <el-col>
